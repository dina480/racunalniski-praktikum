		...
		\begin{column}{0.45\textwidth}
			\centering
							...
							\begin{tikzpicture}
								 ...
								 \coordinate (T') at ({-\td},{\tt});
								 \draw[gray, thin] (T') arc[start angle=60, end angle=-60, radius=2cm] node[left] {\scriptsize $m$};\pause
								 ...
								 \coordinate (T'') at ({\td},{\tt});
								 \draw[gray, thin] (T'') arc[start angle=120, end angle=240, radius=2cm] node[right] {\scriptsize $n$};\pause
								 % % Naloga 3.4.4.: Definirajte in narišite točko C.
								 \coordinate [label={[blue, right]:$C$}] (C) at (0,{-\t});
								 % Risanje točke T
								 \fill[blue] (C) circle (2pt);
		
								 % % Naloga 3.4.5.: Narišite premico skozi točki T in C.
								 \draw[red, very thick] (0,2) -- (0,-2) node[right] {\scriptsize};
